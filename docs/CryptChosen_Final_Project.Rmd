...
<!-- TODO 04/30: Incorporate the rest of regression table values in analysis 3.1 -->
...
Combined with a p-value of **0** and a confidence interval of **19,059.112 to 21,454.848**, our model indicates that the relationship is statistically and practically significant.
...
With another p-value of **0** and a confidence interval of **6.762 to 7.196**, our model shows that this relationship is statistically and practically significant as well.
