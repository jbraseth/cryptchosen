...
<img src="https://stat2.moneycontrol.com/assets/images/ms/wazirx/wazir_article_img_eight.jpg" alt="Crypto Graph" />
...
The Cyprtocompare dataset had a sample size of 5586 for the daily price of BTC from 2009 to the present. The World Bank database, filtering out everything but the g7 countires, had a sample size of 1092, 156 for each country, or one data point a month from 2010 to 2023. We were luckily able to use every single data point and did not have to remove any from either sample.
...
Conclusion. Was there a corelation?

## 5.2 - Limitations

What the limitations we had

## 5.3 - Further questions

Questions the data makes us have
